...
export const YoLiferayJsAmbiente = () => {
  return (
    <div>
        ...
        <Card>
          ...
          <CardContent>
            <ul className="space-y-2 my-2">
              ...
              <li className="flex items-center gap-2">
                <CheckCircle className="h-4 w-4 text-green-500" />
                <span>Yeoman (yo) v4.3.1</span>
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle className="h-4 w-4 text-green-500" />
                <span>generator-liferay-js</span>
              </li>
            </ul>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center">
              ...
              Instalação do Generator
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
              Instale o Yeoman e o generator-liferay-js globalmente:
            </p>
            <CodeBlock code="npm install -g yo@4.3.1 generator-liferay-js" />
            <p className="text-xs text-muted-foreground mt-2">Obs: "yo" na versão 5.0.0 no momento apresenta erros</p>
          </CardContent>
        </Card>
